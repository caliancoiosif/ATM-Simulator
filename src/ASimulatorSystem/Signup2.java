...
public class Signup2 extends JFrame implements ActionListener {
	...
	Signup2(String formno) {
		...
		String religion[] = { "Catholic", "Ortodox", " Christianity", "Buddhism", "Other" };
		c1 = new JComboBox(religion);
		c1.setBackground(Color.WHITE);
		c1.setFont(new Font("Raleway", Font.BOLD, 14));

		String WorkingField[] = { "Health & Medicine", "Computer Science", "Engineering", "Government", "Other" };
		c2 = new JComboBox(WorkingField);
		...
		String education[] = { "Primary", "Secondary", "High-School", "Doctrate", "Others" };
	...
	public void actionPerformed(ActionEvent ae) {
		...
		String WorkingField = (String) c2.getSelectedItem();
